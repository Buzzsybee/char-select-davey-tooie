Lights1 wing_cap_dt_clip_lights = gdSPDefLights1(
	0x7F, 0x66, 0x0,
	0xFF, 0xCE, 0x1, 0x28, 0x28, 0x28);

Texture wing_cap_dt_wing1_rgba16[] = {
	#include "actors/wing_cap_dt/wing1.rgba16.inc.c"
};

Texture wing_cap_dt_wing_2_rgba16[] = {
	#include "actors/wing_cap_dt/wing_2.rgba16.inc.c"
};

Texture wing_cap_dt_CLIP_rgba16[] = {
	#include "actors/wing_cap_dt/CLIP.rgba16.inc.c"
};

Vtx wing_cap_dt_Wing_Cap_DL_mesh_layer_4_vtx_0[8] = {
...
Gfx wing_cap_dt_Wing_Cap_DL_mesh_layer_4_tri_0[] = {
	gsSPVertex(wing_cap_dt_Wing_Cap_DL_mesh_layer_4_vtx_0 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 5, 7, 6, 0),
	gsSPEndDisplayList(),
};

Vtx wing_cap_dt_Wing_Cap_DL_mesh_layer_4_vtx_1[8] = {
...
Gfx wing_cap_dt_Wing_Cap_DL_mesh_layer_4_tri_1[] = {
	gsSPVertex(wing_cap_dt_Wing_Cap_DL_mesh_layer_4_vtx_1 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 7, 4, 6, 0),
	gsSPEndDisplayList(),
};

Vtx wing_cap_dt_Wing_Cap_DL_mesh_layer_1_vtx_0[32] = {
...
Gfx wing_cap_dt_Wing_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(wing_cap_dt_Wing_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
...
Gfx mat_wing_cap_dt_Wing_Base[] = {
	gsSPClearGeometryMode(G_CULL_BACK),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, wing_cap_dt_wing1_rgba16),
...
Gfx mat_revert_wing_cap_dt_Wing_Base[] = {
...
Gfx mat_wing_cap_dt_Wing_Tip[] = {
	gsSPClearGeometryMode(G_CULL_BACK),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, wing_cap_dt_wing_2_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadBlock(7, 0, 0, 2047, 256),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, 0, 0, G_TX_CLAMP | G_TX_NOMIRROR, 6, 0, G_TX_CLAMP | G_TX_NOMIRROR, 5, 0),
	gsDPSetTileSize(0, 0, 0, 124, 252),
...
Gfx mat_revert_wing_cap_dt_Wing_Tip[] = {
	gsSPSetGeometryMode(G_CULL_BACK),
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsSPEndDisplayList(),
...
Gfx mat_wing_cap_dt_clip[] = {
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, 0, 0, 0, ENVIRONMENT, TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, wing_cap_dt_CLIP_rgba16),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 0, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
...
Gfx mat_revert_wing_cap_dt_clip[] = {
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsSPEndDisplayList(),
};

Gfx wing_cap_dt_Wing_Cap_DL_mesh_layer_4[] = {
	gsSPDisplayList(mat_wing_cap_dt_Wing_Base),
	gsSPDisplayList(wing_cap_dt_Wing_Cap_DL_mesh_layer_4_tri_0),
	gsSPDisplayList(mat_revert_wing_cap_dt_Wing_Base),
	gsSPDisplayList(mat_wing_cap_dt_Wing_Tip),
	gsSPDisplayList(wing_cap_dt_Wing_Cap_DL_mesh_layer_4_tri_1),
	gsSPDisplayList(mat_revert_wing_cap_dt_Wing_Tip),
	gsSPEndDisplayList(),
};

Gfx wing_cap_dt_Wing_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_wing_cap_dt_clip),
	gsSPDisplayList(wing_cap_dt_Wing_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_wing_cap_dt_clip),
	gsSPEndDisplayList(),
};

Gfx wing_cap_dt_material_revert_render_settings[] = {
	gsDPPipeSync(),
