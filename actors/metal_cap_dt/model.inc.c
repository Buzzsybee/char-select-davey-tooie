Lights1 metal_cap_dt_clip_lights = gdSPDefLights1(
	0x7F, 0x66, 0x0,
	0xFF, 0xCE, 0x1, 0x28, 0x28, 0x28);

Texture metal_cap_dt_CLIP_rgba16[] = {
	#include "actors/metal_cap_dt/CLIP.rgba16.inc.c"
};

Vtx metal_cap_dt_Metal_Cap_DL_mesh_layer_1_vtx_0[32] = {
...
Gfx metal_cap_dt_Metal_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(metal_cap_dt_Metal_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
...
Gfx mat_metal_cap_dt_clip[] = {
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, 0, 0, 0, ENVIRONMENT, TEXEL0, SHADE, TEXEL0_ALPHA, SHADE, 0, 0, 0, ENVIRONMENT),
	gsDPSetAlphaDither(G_AD_NOISE),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b_LOAD_BLOCK, 1, metal_cap_dt_CLIP_rgba16),
...
Gfx mat_revert_metal_cap_dt_clip[] = {
	gsDPPipeSync(),
	gsDPSetAlphaDither(G_AD_DISABLE),
	gsSPEndDisplayList(),
};

Gfx metal_cap_dt_Metal_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_metal_cap_dt_clip),
	gsSPDisplayList(metal_cap_dt_Metal_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_metal_cap_dt_clip),
	gsSPEndDisplayList(),
};

Gfx metal_cap_dt_material_revert_render_settings[] = {
	gsDPPipeSync(),
